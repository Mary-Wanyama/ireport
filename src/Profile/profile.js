...
function Profile() {
  return (
    ...
    <div className="bg-yellow-400 w-72 shadow-2xl text-lg align-self-center">
    <p className='text-red-500'>Arma</p>
    </div>
  ...
  <div className="pt-6 flex-initial w-96 text-center mx-auto space-y-4">
    <blockquote>
    <div className="text-teal-500 font-bold text-3xl my-7">
      {/* {username} */}
        Fred Matiang'i
      </div>
      <p className="">
      ...
      <h1 className='text-2xl font-semibold pt-16 text-green-700'>Add New Report</h1>
